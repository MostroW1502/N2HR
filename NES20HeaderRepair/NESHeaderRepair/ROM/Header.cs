...
namespace NES20HeaderRepair.NESHeaderRepair.ROM
{
    public partial class Header : NES2Header
    {
        ...
        public string PRGROMSHA1AsString
        {
            get
            {
                return SHA1ToString(PRGROMSHA1);
            }
        }
        ...
        public string CHRROMSHA1AsString
        {
            get
            {
                return CHRROMSize > 0 ? SHA1ToString(CHRROMSHA1) : string.Empty;
            }
        }
        ...
        private byte[] GetBytes(int offset, int count, byte[] data)
        {
        ...
        private ushort CalculateSUM16(byte[] data)
        {
            ushort sum = 0;
